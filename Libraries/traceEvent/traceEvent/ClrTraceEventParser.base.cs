...
namespace System.Diagnostics.Eventing.Parsers
{
    ...
    public sealed class DotNETRuntimeTraceEventParser : TraceEventParser 
    {
        ...
        public DotNETRuntimeTraceEventParser(TraceEventSource source) : base(source) {}
    ...
    public sealed class DotNETRuntimeRundownTraceEventParser : TraceEventParser 
    {
        ...
        public DotNETRuntimeRundownTraceEventParser(TraceEventSource source) : base(source) {}
    ...
    public sealed class MethodLoadUnloadRundownTraceData : TraceEvent
    {
        public long MethodID { get { return GetInt64At(0); } }
        public long ModuleID { get { return GetInt64At(8); } }
        public long MethodStartAddress { get { return GetInt64At(16); } }
        ...
        #region Private
        internal MethodLoadUnloadRundownTraceData(Action<MethodLoadUnloadRundownTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        public override StringBuilder ToXml(StringBuilder sb)
        {
             ...
             sb.XmlAttrib("MethodToken", MethodToken);
             sb.XmlAttrib("MethodFlags", MethodFlags);
             sb.XmlAttrib("ClrInstanceID", ClrInstanceID);
             sb.Append("/>");
             return sb;
        ...
        private event Action<MethodLoadUnloadRundownTraceData> Action;
        #endregion
    }
    public sealed class MethodLoadUnloadRundownVerboseTraceData : TraceEvent
    {
        public long MethodID { get { return GetInt64At(0); } }
        public long ModuleID { get { return GetInt64At(8); } }
        public long MethodStartAddress { get { return GetInt64At(16); } }
        ...
        #region Private
        internal MethodLoadUnloadRundownVerboseTraceData(Action<MethodLoadUnloadRundownVerboseTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        private event Action<MethodLoadUnloadRundownVerboseTraceData> Action;
        #endregion
    }
    ...
    public sealed class DomainModuleLoadUnloadRundownTraceData : TraceEvent
    {
        public long ModuleID { get { return GetInt64At(0); } }
        public long AssemblyID { get { return GetInt64At(8); } }
        public long AppDomainID { get { return GetInt64At(16); } }
        ...
        #region Private
        internal DomainModuleLoadUnloadRundownTraceData(Action<DomainModuleLoadUnloadRundownTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        private event Action<DomainModuleLoadUnloadRundownTraceData> Action;
        #endregion
    }
    public sealed class ModuleLoadUnloadRundownTraceData : TraceEvent
    {
        public long ModuleID { get { return GetInt64At(0); } }
        public long AssemblyID { get { return GetInt64At(8); } }
        public ModuleFlags ModuleFlags { get { return (ModuleFlags)GetInt32At(16); } }
        ...
        #region Private
        internal ModuleLoadUnloadRundownTraceData(Action<ModuleLoadUnloadRundownTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        public override string[] PayloadNames
        {
            ...
            {
                if (payloadNames == null)
                    payloadNames = new string[] { "ModuleID", "AssemblyID", "ModuleFlags", "ModuleILPath", "ModuleNativePath", "ClrInstanceID"};
                return payloadNames;
            }
        }
        ...
        private event Action<ModuleLoadUnloadRundownTraceData> Action;
        #endregion
    }
    public sealed class AssemblyLoadUnloadRundownTraceData : TraceEvent
    {
        public long AssemblyID { get { return GetInt64At(0); } }
        public long AppDomainID { get { return GetInt64At(8); } }
        public AssemblyFlags AssemblyFlags { get { if (Version >= 1) return (AssemblyFlags)GetInt32At(24); return (AssemblyFlags)GetInt32At(16); } }
        ...
        #region Private
        internal AssemblyLoadUnloadRundownTraceData(Action<AssemblyLoadUnloadRundownTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        private event Action<AssemblyLoadUnloadRundownTraceData> Action;
        #endregion
    }
    public sealed class AppDomainLoadUnloadRundownTraceData : TraceEvent
    {
        public long AppDomainID { get { return GetInt64At(0); } }
        public AppDomainFlags AppDomainFlags { get { return (AppDomainFlags)GetInt32At(8); } }
        public string AppDomainName { get { return GetUnicodeStringAt(12); } }
        ...
        #region Private
        internal AppDomainLoadUnloadRundownTraceData(Action<AppDomainLoadUnloadRundownTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        private event Action<AppDomainLoadUnloadRundownTraceData> Action;
        #endregion
    }
    public sealed class ThreadCreatedRundownTraceData : TraceEvent
    {
        public long ManagedThreadID { get { return GetInt64At(0); } }
        public long AppDomainID { get { return GetInt64At(8); } }
        public int Flags { get { return GetInt32At(16); } }
        ...
        #region Private
        internal ThreadCreatedRundownTraceData(Action<ThreadCreatedRundownTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        private event Action<ThreadCreatedRundownTraceData> Action;
        #endregion
    }
    public sealed class RuntimeInformationRundownTraceData : TraceEvent
    {
        public int ClrInstanceID { get { return GetInt16At(0); } }
        public RuntimeSku Sku { get { return (RuntimeSku)GetInt16At(2); } }
        public int BclMajorVersion { get { return GetInt16At(4); } }
        ...
        #region Private
        internal RuntimeInformationRundownTraceData(Action<RuntimeInformationRundownTraceData> action, int eventID, int task, string taskName, Guid taskGuid, int opcode, string opcodeName, Guid providerGuid, string providerName)
            : base(eventID, task, taskName, taskGuid, opcode, opcodeName, providerGuid, providerName)
        {
            this.Action = action;
        }
        ...
        private event Action<RuntimeInformationRundownTraceData> Action;
        #endregion
    }
        [Flags]
        public enum AppDomainFlags
    ...
    public sealed class DotNETRuntimeStressTraceEventParser : TraceEventParser 
    {
        ...
        public DotNETRuntimeStressTraceEventParser(TraceEventSource source) : base(source) {}
